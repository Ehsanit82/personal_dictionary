...
class WordListWidget extends StatefulWidget {
  WordListWidget({Key? key, required this.constraints, required this.limit})
      : super(key: key);
...
class _ItemWidgetState extends State<ItemWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    final words = context.watch<FilteredWordsBloc>().state.wordList;
    ...
    return InkWell(
      ...
      child: Container(
        ...
        height: widget.isExtended ? 120 : 70,
